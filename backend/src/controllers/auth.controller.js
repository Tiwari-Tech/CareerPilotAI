...
const JWT_EXPIRY = "1d";
const COOKIE_MAX_AGE = 24 * 60 * 60 * 1000; // 1 day, matches JWT_EXPIRY

// Cross-domain deployments (frontend and backend on different domains)
// need sameSite:'none' + secure:true for the cookie to be sent at all.
// Same-domain deployments can use the more restrictive 'lax'.
